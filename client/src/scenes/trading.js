  ...
  constructor(scene, room) {
    ...
    room.onMessage(
      ...
      (data) => {
        ...
        scene.noButton.setInteractive().on(
          "pointerdown",
          () => {
        ...
        room.onMessage(
          ...
          function (data) {
            ...
            data.trades.forEach((item) => {
              ...
              currentTrade.container.setPosition(
                currentTrade.container.x +
                  currentTrade.rectangle.width / 2 +
                  10,
                currentTrade.container.y +
                  currentTrade.rectangle.height / 2 +
                  10
              );
              x += currentTrade.rectangle.width;
              if (
                currentTrade.rectangle.getTopRight().x >
                scene.stage.getTopRight().x
              ) {
