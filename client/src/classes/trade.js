  ...
  constructor(x, y, id, name, buy, sell, scene, room) {
    ...
    this.rectangle = scene.add
      .rectangle(
        x,
        y,
        (scene.stage.width * scene.stage.scaleX) / 3 - 5,
        (scene.stage.height * scene.stage.scaleY) / 3
      )
      .setFillStyle(0x000000)
      .setStrokeStyle(3, 0x3436738, 1);
    this.name = scene.add
      .bitmapText(
        this.rectangle.x,
    ...
    this.acceptBox = scene.add
      .rectangle(this.rectangle.x, this.rectangle.y + 75, 110, 50)
      .setFillStyle(0x000000)
      .setStrokeStyle(4, 0x3436738, 1);
    this.accept = scene.add
      .bitmapText(
        this.acceptBox.x,
        this.acceptBox.y,
        "spaceCrusaders",
